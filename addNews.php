...
<div class="container">
	...
	<div class="row clearfix">
		...
		<div class="col-md-6 column">
			<form role="form" action="addAction.php" method="POST">
				<div class="form-group">
					 <label for="exampleInputPassword1">Title</label><input type="text" class="form-control" id="exampleInputPassword1" />
				</div>
				<div class="form-group">
