...
<div class="container">
	...
	<div class="row clearfix">
      ...
      <form role="form" action="registerAction.php" method="post">
            ...
            <div class="control-group">
							...
							<div class="controls">
								<input id="inputPassword" type="password" name="passwordConfirm"/>
							</div>
						</div>
            <div class="control-group">
							 <label class="control-label" for="inputPassword">姓名</label>
							<div class="controls">
								<input id="inputPassword" type="text" name="name"/>
							</div>
						</div>
            <div class="control-group">
							 <label class="control-label" for="inputPassword">姓名</label>
